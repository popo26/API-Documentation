...
export default function clickTryOutBtnToShowRunBtn(className, runBtn, httpMethod) {
  runBtn.addEventListener("click", function () {
    const individualRunBtn = document.querySelector(`.run${className}${httpMethod}`);
    const runBtnMsg = document.querySelector(`.runMsg${className}${httpMethod}`);
    ...
    const paramsDiv = document.querySelector(`.paramDiv${className}${httpMethod}`);
    const resultStatusCode = document.querySelector(
      `.resultStatus${className}${httpMethod}`
    );
    const individualParamInput = document.querySelector(`.p${className}${httpMethod}`);
